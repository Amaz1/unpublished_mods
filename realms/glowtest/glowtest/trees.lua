...
function glowtest_sgreentree(x, y, z, area, data)
	local c_gleaves = minetest.get_content_id("glowtest:greenleaf")
	...
	for j = -2, t do
		if j == t or j == t - 2 then
			for i = -2, 2 do
			for k = -2, 2 do
				local vi = area:index(x + i, y + j + math.random(0, 1), z + k)
...
function glowtest_sbluetree(x, y, z, area, data)
	local c_bleaves = minetest.get_content_id("glowtest:blueleaf")
	local c_tree = minetest.get_content_id("glowtest:tree")
	local t = 4 + math.random(2) -- trunk height
	for j = -2, t do
		if j == t or j == t - 2 then
...
function glowtest_spinktree(x, y, z, area, data)
	local c_pleaves = minetest.get_content_id("glowtest:pinkleaf")
	local c_tree = minetest.get_content_id("glowtest:tree")
	local t = 4 + math.random(2) -- trunk height
	for j = -2, t do
		if j == t or j == t - 2 then
...
function glowtest_syellowtree(x, y, z, area, data)
	local c_yleaves = minetest.get_content_id("glowtest:yellowleaf")
	local c_tree = minetest.get_content_id("glowtest:tree")
	local t = 4 + math.random(2) -- trunk height
	for j = -2, t do
		if j == t or j == t - 2 then
...
function glowtest_swhitetree(x, y, z, area, data)
	local c_wleaves = minetest.get_content_id("glowtest:whiteleaf")
	local c_tree = minetest.get_content_id("glowtest:tree")
	local t = 4 + math.random(2) -- trunk height
	for j = -2, t do
		if j == t or j == t - 2 then
...
function glowtest_sredtree(x, y, z, area, data)
	local c_rleaves = minetest.get_content_id("glowtest:redleaf")
	local c_tree = minetest.get_content_id("glowtest:tree")
	local t = 4 + math.random(2) -- trunk height
	for j = -2, t do
		if j == t or j == t - 2 then
...
function glowtest_sblacktree(x, y, z, area, data)
	local c_bleaves = minetest.get_content_id("glowtest:blackleaf")
	local c_tree = minetest.get_content_id("glowtest:tree")
	local t = 4 + math.random(2) -- trunk height
	for j = -2, t do
		if j == t or j == t - 2 then
